...
export default function HeroSection () {
  ...
  return <div className="flex flex-col min-h-screen bg-gradient-to-br from-[#FFC107] to-[#FF6B6B]">

<header className="bg-gradient-to-b from-[#4158D0] to-[#C850C0] py-4 px-6 shadow-md">
        <div className="flex justify-between items-center">
          <Link href="#" className="flex items-center gap-2 text-white font-bold text-2xl" prefetch={false}>
            <SmileIcon className="w-8 h-8" />
            <span>Strangers Online </span>
          </Link>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
              <Card>
                <CardContent className="flex flex-col items-center justify-center p-6">
                  ...
                  <Button
                    className="bg-[#FF6B6B] hover:bg-[#E53935] text-white font-bold py-2 px-4 rounded mt-4"
                    href="#"
                  >
                    Jugar
                  </Button>
              ...
              <Card>
                <CardContent className="flex flex-col items-center justify-center p-6">
                  ...
                  <Button
                    className="bg-[#9C27B0] hover:bg-[#7B1FA2] text-white font-bold py-2 px-4 rounded mt-4"
                    href="#"
                  >
                    Jugar
                  </Button>
             ...
             <Card> 
                <CardContent className="flex flex-col items-center justify-center p-6">
                  ...
                  <Button
                    className="bg-[#673AB7] hover:bg-[#512DA8] text-white font-bold py-2 px-4 rounded mt-4"
                    href="#"
                  >
                    Jugar
                  </Button>
